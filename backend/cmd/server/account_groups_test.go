...
func TestAccountGroupsAndLogin(t *testing.T) {
	...
	call("POST", "/api/account-groups", 1, map[string]any{"name": "Other", "user_id": 2}, 403)
	...
	call("POST", "/api/accounts/1/login", 2, map[string]any{"logged_in_at": at}, 404)
